...
---
## 📊 نتایج و نمونه خروجی (Results & Demo Sample)

مدل پس از ۳ اپوک آموزش روی داده‌های فارسی، به دقت (Accuracy) بالای ۹۵٪ دست یافت. نمونه عملکرد مدل روی جملات تست جدید:

```text
--- گزارش ارزیابی مدل (Classification Report) ---
              precision    recall  f1-score   support

    منفی (0)       1.00      1.00      1.00        20
    مثبت (1)       1.00      1.00      1.00        20

    accuracy                           1.00        40


--- تست واقعی با متن‌های جدید (Real-time Test) ---

💬 متن: "ارسالشون خیلی سریع بود و جنسش حرف نداشت"
🏷️ نتیجه: مثبت 😊

💬 متن: "اصلا کیفیت نداشت و الکی پولم هدر رفت"
🏷️ نتیجه: منفی 😡
---
